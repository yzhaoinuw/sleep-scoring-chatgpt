...
from sleep_scoring_chatgpt.config import FIX_NE_Y_RANGE
from sleep_scoring_chatgpt.get_fft_plots import get_fft_plots
...
if __name__ == "__main__":
    ...
    mat_file = "COM5_bin1_gpt5.5_medium.mat"
