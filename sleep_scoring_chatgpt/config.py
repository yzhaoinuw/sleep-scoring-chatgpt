...
CHATGPT_CONFIDENCE_THRESHOLD = 0.0
CHATGPT_SHOW_THOUGHTS = True
CHATGPT_INFERENCE_MODE = "fixed_windows"  # "overview_only" or "fixed_windows"
CHATGPT_REFINEMENT_WINDOW_SECONDS = 3600
CHATGPT_USE_REFERENCE_EXAMPLES = False
